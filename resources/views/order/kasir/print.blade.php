...
<body>
  ...
  <div id="receipt">
    ...
    <div id="mid">
      <div class="info">
        <p>
          Alamat : spanjang jalan kenangan<br>
    ...
    <div id="bot">
      ...
      <div id="legalcopy">
        <p class="legal"><strong>Terima kasih atas pembelian Anda!</strong> Lorem ipsum dolor sit amet consectetur adipisicing elit. Ullam, vero! Rem amet nam qui! Sint dignissimos natus reprehenderit. Est non, libero reiciendis magnam deleniti nemo voluptates cum voluptas fugit quis?</p>
      </div>
    </div>
  </div>
</body>
